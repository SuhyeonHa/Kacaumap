...
public class NaviStartSearch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_navi_start_search);
        ...
        final String[] destPOI = intent1.getStringArrayExtra("destPOI");
        ...
        mListViewList.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(destPOI==null) {
                    ...
                    sdPOI= new String[]{mArrayList.get(position).get(TAG_Building),mArrayList.get(position).get(TAG_RoomNum),mArrayList.get(position).get(TAG_Name), destPOI[0], destPOI[1], destPOI[2]};
                }
    ...
    private void showResult() {
        ...
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    ...
                    NaviStartSearch.this, mArrayList, R.layout.item_list,
    ...
    private class GetData extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(NaviStartSearch.this,
