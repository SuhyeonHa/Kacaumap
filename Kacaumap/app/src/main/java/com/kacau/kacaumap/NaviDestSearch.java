...
public class NaviDestSearch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_navi_dest_search);
        ...
        final String[] startPOI = intent1.getStringArrayExtra("startPOI");
        final String[] gps = intent1.getStringArrayExtra("gps");
        ...
        mListViewList.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(NaviDestSearch.this, Navigation.class);

                if(startPOI==null) {
                    sdPOI = new String[]{"","","", mArrayList.get(position).get(TAG_Building),mArrayList.get(position).get(TAG_RoomNum),mArrayList.get(position).get(TAG_Name)};
                }
                else {
                    sdPOI = new String[]{startPOI[0], startPOI[1], startPOI[2], mArrayList.get(position).get(TAG_Building), mArrayList.get(position).get(TAG_RoomNum), mArrayList.get(position).get(TAG_Name)};
    ...
    private void showResult() {
        ...
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    ...
                    NaviDestSearch.this, mArrayList, R.layout.item_list,
    ...
    private class GetData extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(NaviDestSearch.this,
